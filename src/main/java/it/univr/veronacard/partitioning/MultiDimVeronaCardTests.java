...
//import static it.univr.veronacard.partitioning.PartVeronaCard.generateContextBasedParts;
import static it.univr.veronacard.partitioning.QueryVeronaCard.rangeContextQuery;
import static it.univr.veronacard.partitioning.StatsVeronaCard.buildStatFile;
 ...
 * @version 0.0.0
 */
public class MultiDimVeronaCardTests {
  ...
  private static void buildIndexes() throws IOException {
    ...
    final VeronaCardBoundaries b = computeBoundaries( lines, separator );
    /*
  ...
  public static void countAges( String outputFile ) throws IOException {
  ...
  private static void testQueries() throws ParseException {
    ...
    //final QueryParamsVeronaCard params = new QueryParamsVeronaCard
    final QueryVeronaCard params = new QueryVeronaCard( new QueryParamsVeronaCard
        ( minX, maxX,
            minY, maxY,
